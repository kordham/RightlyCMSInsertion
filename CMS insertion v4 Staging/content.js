...
function populate() {
    ...
    xhr.send();
	*/
	var csv = 'University of Stirling,hi@example.cc.1,00_Trial,education,\"University in Stirling, UK\"\nUniversity of Essex,hi@example.c.1,00_Trial,education,\"University in Colchester, UK\"\nSOAS University of London,hi@example.c.11,00_Trial,education,\nUniversity of Leicester,hi @example.cs,00_Trial,education,\"University in Leicester, UK\"\nSt George\'s University of London,hi@example.com,00_Trial,education,0';
